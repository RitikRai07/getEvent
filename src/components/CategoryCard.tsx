...
const CategoryCard = ({ title, icon: Icon, count, image }: CategoryCardProps) => {
  return (
    <Card className="group transition-all duration-300 cursor-pointer border-transparent hover:border-purple-500/40 overflow-hidden relative h-48 hover:scale-[1.01] hover:shadow-lg hover:shadow-purple-500/20 z-0 hover:z-10">
