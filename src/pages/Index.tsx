...
import { PartnerCardHover } from "@/components/PartnerCardHover";
import SplitText from "@/components/SplitText";
import "@/components/PartnerCardHover.css";
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <LogoLoop
          ...
          fadeOut
          scaleOnHover
          ariaLabel="Browse events by category"
        />
      </section>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <LogoLoop
            logos={partners.map(partner => ({
              node: (
                <PartnerCardHover glowColor="147, 51, 234">
                  <Card className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 cursor-pointer w-[280px]">
